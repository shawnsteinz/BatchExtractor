...
class Main():
    ...
    def __init__(self):
        self.sh = ShelveHandler('C:\\Users\\Shawn\\Desktop\\test\\DB\\Shelve')
        self.sh.set_setting('src', 'C:\\Users\\Shawn\\Desktop\\Test\\SRC')
        self.sh.set_setting('des', 'C:\\Users\\Shawn\\Desktop\\Test\\DES')
